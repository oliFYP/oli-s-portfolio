...
function Presentation() {
  ...
  const openLinkedInProfile = () => {
    const linkedInProfileURL = "https://www.linkedin.com/in/olivier-smith-2378b8205/";
  ...
  return (
    <div className="absolute top-1/4 sm:right-1/2 transform z-10">
      ...
      <div style={{ marginLeft: '10px', marginRight: '15px' }}>
        ...
        <div className="mt-3 flex">
          <img src={logo1} className="h-8 mr-2 ml-8 cursor-pointer transition duration-500 ease-in-out transform hover:scale-110 hover:shadow-white" alt="Logo 1" onClick={openInstagramProfile} />
          <img src={logo2} className="h-8 mr-2 cursor-pointer transition duration-500 ease-in-out transform hover:scale-110 hover:shadow-white" alt="Logo 2" onClick={openGithubProfile} />
          <img src={logo3} className="h-8 cursor-pointer transition duration-500 ease-in-out transform hover:scale-110 hover:shadow-white-xl" alt="Logo 3" onClick={openLinkedInProfile} />
        </div>
      </div>
    </div>
  );
