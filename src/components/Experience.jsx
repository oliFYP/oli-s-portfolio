...
function Experience() {
  ...
  return (
    <div className="bg-black h-auto w-auto p-6">
        ...
        <div className="flex flex-wrap justify-center">
          {iconSources.map((icon, index) => (
            <div key={index} className="w-1/2 md:w-1/4 lg:w-1/5 p-2">
              <div className="w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 bg-gray-800 flex flex-col items-center justify-center rounded-lg mx-auto">
