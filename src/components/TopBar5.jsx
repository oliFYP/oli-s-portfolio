...
function Topbar3({ isSidePanelOpen, toggleSidePanel }) {
  ...
  return (
    <div
      ...
      className="relative w-full h-100 z-999 flex bg-gradient-to-r from-black to-gray-600 justify-between items-center" // Applying utility classes for layout and positioning
    >
